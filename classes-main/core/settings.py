...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.ga4_context',  # Google Analytics 4 context
            ],
        },
    },
]
...
# Monitoring service URLs (optional in production; local defaults can still be provided via .env)
GRAFANA_URL = os.environ.get('GRAFANA_URL', '')
PROMETHEUS_URL = os.environ.get('PROMETHEUS_URL', '')
LOCUST_URL = os.environ.get('LOCUST_URL', '')
PROMETHEUS_HEALTH_URL = os.environ.get(
    'PROMETHEUS_HEALTH_URL', f"{PROMETHEUS_URL}/-/healthy" if PROMETHEUS_URL else ''
)
GRAFANA_HEALTH_URL = os.environ.get(
