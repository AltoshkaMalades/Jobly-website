...
class SecurityHeadersMiddleware:
    ...
    def __call__(self, request):
        ...
        response['Content-Security-Policy'] = (
            "default-src 'self' *; "
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.google.com https://www.gstatic.com https://cdn.tailwindcss.com https://www.paypal.com; "
            ...
            "frame-src 'self' https://www.google.com https://recaptcha.net https://www.paypal.com https://sandbox.paypal.com; "
            "connect-src 'self' *;"
        )
