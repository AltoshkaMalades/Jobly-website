...
class SecurityHeadersMiddleware:
    ...
    def __call__(self, request):
        ...
        response['Content-Security-Policy'] = (
            "default-src 'self' *; "
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.google.com https://www.gstatic.com https://www.googletagmanager.com https://us.i.posthog.com https://us-assets.i.posthog.com https://cdn.tailwindcss.com https://www.paypal.com https://www.sandbox.paypal.com; "
            ...
            "connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://us.i.posthog.com https://us-assets.i.posthog.com *;"
        )
