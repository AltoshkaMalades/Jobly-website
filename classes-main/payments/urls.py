...
urlpatterns = [
    ...
    path('metrics-public/', dashboard_views.saas_metrics_public, name='saas_metrics_public'),
    path('payments/metrics/', dashboard_views.saas_metrics, name='saas_metrics_payments'),
